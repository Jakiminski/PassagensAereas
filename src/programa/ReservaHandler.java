...
/**
 * Manipula e gerencia as Reservas
...
public class ReservaHandler {
    ...
    private String messageError;
        ...
        // MÉTODOS
    /**
     * Reserva de Assento não ocupado
     * @since 1.0
     * @param cliente Cliente/usuário que fará a reserva 
     * @param s Objeto do tipo Assento ao qual tem-se intenção de comprar
     * @param voo Objeto do tipo Voo desejado pelo cliente
     * @param reservarNaPrimClasse boolean que determina se a reserva é ou não na 1a classe
     * @return Reserva feita, senão 'null'
     */
     ...
     * @return 'true' se a reserva não foi comprada e for cancelada\
     * senão 'false'
     */
     ...
     * @since 1.0
     * @param reserva Objeto do tipo Reserva
     * @param novoAssento Objeto do tipo Assento ao qual se deseja mudar
     * @return Reserva feita pelo usuário
     */
    ...
    /**
     * Imprime um protótipo de cartão de embarque
     * @since 1.0
     * @param r Reserva que será impressa
     * @return 'true' se houver um cartão, senão 'false'
     */
     ...
     * Mensagem de erro
     * @since 1.0
     * @return 'null' se não houver erros, senão messageError
     */
     ...
     * @since 1.0
     * @param s String
     * @param aviao Objeto do tipo Aviao
     * @param gc Gerenciados de Clientes
     * @return Reserva se possível, senão 'null'
     */
