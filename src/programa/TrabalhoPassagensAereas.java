...
/**
 * O Programa consiste na compra de Passagens Aéreas
 * <p>
 * O cliente se cadastra, faz um login e consulta voos.\
 * após ceder seus dados de cadastro, ele loga conforme seu ID\
 * podendo CONSULTAR, RESERVAR, COMPRAR, REMARCAR e\ 
 * CANCELAR suas reservas/passagens aéreas.
 * <p>

 * @author João Marcello, Jonas Jakiminski
 * @version 2.0
 * @since 1.0
 */
