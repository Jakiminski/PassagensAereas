...
import programa.Aviao;
import programa.GerenciadorClientes;
...
public class MenuPrincipal extends JFrame implements ActionListener {
    ...
    public MenuPrincipal(GerenciadorClientes gc){
        ...
        Icon planeIcon = new ImageIcon(getClass().getResource("plane.png"));
        JLabel iconLabel = new JLabel(planeIcon);
        ...
        com.weighty = 10;
        addComponent(topPanel, Box.createVerticalStrut(20), l1, com, 0,0,4,1);
        addComponent(topPanel, Box.createVerticalStrut(20), l1, com, 3,1,3,1);
        addComponent(topPanel, Box.createHorizontalStrut(20), l1, com, 1,0,1,2);
        addComponent(topPanel, Box.createHorizontalStrut(20), l1, com, 1,3,1,2);
        
        com.weighty = 0;
        addComponent(topPanel, iconLabel, l1, com, 1,1,1,2);
        
        com.weighty = 1;
        com.anchor = GridBagConstraints.SOUTH;
        addComponent(topPanel, companyLabel, l1, com, 1,2,1,1);
        com.anchor = GridBagConstraints.NORTH;
        addComponent(topPanel, company2Label, l1, com, 2,2,1,1);
